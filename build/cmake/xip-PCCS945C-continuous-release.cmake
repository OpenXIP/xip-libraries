...
SET(CTEST_SOURCE_NAME xip-continuous)
SET(CTEST_BINARY_NAME xip-continuous-release)
...
SET(CTEST_CVS_CHECKOUT "${CTEST_CVS_COMMAND} checkout https://collab01a.scr.siemens.com/svn/xip/trunk xip-continuous")

# which ctest command to use for running the dashboard
SET(CTEST_COMMAND
 "\"C:/Program Files/CMake 2.4/bin/ctest.exe\" -D Continuous -A ${CTEST_SCRIPT_DIRECTORY}/${CTEST_SCRIPT_NAME}")
