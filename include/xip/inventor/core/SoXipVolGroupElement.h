...
*/#ifndef  SOXIPVOLGROUPELEMENT_H
#define  SOXIPVOLGROUPELEMENT_H
...
*/
class XIPIVCORE_API SoXipVolGroupElement : public SoAccumulatedElement 
{
	SO_ELEMENT_HEADER(SoXipVolGroupElement);

public:
    /// Initializes the SoXipVolGroupElement class
    ...
    static SoXipVolGroupElement* getInstance(SoState *state);
