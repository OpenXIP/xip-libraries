...
public class ivCanvas extends Canvas implements ComponentListener ,java.awt.event.KeyListener,java.awt.event.MouseListener,java.awt.event.MouseMotionListener
{
    ...
    static {
        loadDll();
        //System.load("E:\\official_projects\\RAD_projects\\ivJavaAppletTrials\\ivJavaNetv1\\source\\bin\\ivCanvas.dll");
      }
               ...
               public Object run(){
                   try {
                       ...
                       InputStream inputStream =
                               ivCanvas.class.getResource("/ivCanvas.dll").openStream();
                       
                       // Copy resource to filesystem in a temp folder with a unique name
                       File temporaryDll = File.createTempFile("ivCanvas", ".dll");
