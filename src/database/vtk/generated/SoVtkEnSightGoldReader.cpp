...
SoVtkEnSightGoldReader::SoVtkEnSightGoldReader()
{
	SO_ENGINE_CONSTRUCTOR(SoVtkEnSightGoldReader);

	mObject = vtkEnSightGoldReader::New();
	mObject->Register(0);
	mObject->SetGlobalWarningDisplay(0);

	vtkEnSightGoldReader *aEnSightGoldReader = vtkEnSightGoldReader::New();
	double *x = 0;
	int *y = 0;
	float *z = 0;

	SO_ENGINE_ADD_INPUT(ByteOrder, (0));
	ByteOrder.setValue(aEnSightGoldReader->GetByteOrder());
	...
	ReadAllVariables.setValue(aEnSightGoldReader->GetReadAllVariables());

	aEnSightGoldReader->Delete();
...
void SoVtkEnSightGoldReader::initClass()
{
	SO_ENGINE_INIT_CLASS( SoVtkEnSightGoldReader, SoEngine, "Engine" );
}

void SoVtkEnSightGoldReader::evaluate()
{
	try
	{
...
void SoVtkEnSightGoldReader::inputChanged(SoField * f)
{
