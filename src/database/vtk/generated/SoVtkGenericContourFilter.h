...
# ifndef SO_VTK_GENERICCONTOURFILTER_H_
# define SO_VTK_GENERICCONTOURFILTER_H_
...
class SoVtkGenericContourFilter : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkGenericContourFilter );

public:

	/// Constructor
	SoVtkGenericContourFilter();
...
private:
	...
	vtkGenericContourFilter* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_GENERICCONTOURFILTER_H_
