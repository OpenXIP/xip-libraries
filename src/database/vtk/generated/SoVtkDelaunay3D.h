...
# ifndef SO_VTK_DELAUNAY3D_H_
# define SO_VTK_DELAUNAY3D_H_
...
class SoVtkDelaunay3D : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkDelaunay3D );
...
private:
	...
	vtkDelaunay3D* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_DELAUNAY3D_H_
