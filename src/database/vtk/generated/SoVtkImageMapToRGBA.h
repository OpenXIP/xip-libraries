...
# ifndef SO_VTK_IMAGEMAPTORGBA_H_
# define SO_VTK_IMAGEMAPTORGBA_H_
...
class SoVtkImageMapToRGBA : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkImageMapToRGBA );
...
private:
	...
	vtkImageMapToRGBA* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_IMAGEMAPTORGBA_H_
