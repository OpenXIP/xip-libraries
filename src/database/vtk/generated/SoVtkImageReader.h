...
# ifndef SO_VTK_IMAGEREADER_H_
# define SO_VTK_IMAGEREADER_H_
...
class SoVtkImageReader : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkImageReader );
...
private:
	...
	vtkImageReader* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_IMAGEREADER_H_
