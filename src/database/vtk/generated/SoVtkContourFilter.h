...
# ifndef SO_VTK_CONTOURFILTER_H_
# define SO_VTK_CONTOURFILTER_H_
...
class SoVtkContourFilter : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkContourFilter );
...
public:
	...
	/// ScalarTree of type vtkScalarTree
	SoSFVtkObject ScalarTree;
	/// ComputeGradients
...
private:
	...
	vtkContourFilter* mObject;
};

#endif // SO_VTK_CONTOURFILTER_H_
