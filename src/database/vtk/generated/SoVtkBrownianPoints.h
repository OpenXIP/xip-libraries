...
# ifndef SO_VTK_BROWNIANPOINTS_H_
# define SO_VTK_BROWNIANPOINTS_H_
...
class SoVtkBrownianPoints : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkBrownianPoints );
...
public:
	...
	// Inputs
	/// MaximumSpeed
	SoSFFloat MaximumSpeed;
	/// MinimumSpeed
	SoSFFloat MinimumSpeed;
	/// Input connection 
...
private:
	...
	vtkBrownianPoints* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_BROWNIANPOINTS_H_
