...
# ifndef SO_VTK_GENERICCLIP_H_
# define SO_VTK_GENERICCLIP_H_
...
class SoVtkGenericClip : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkGenericClip );
...
private:
	...
	vtkGenericClip* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_GENERICCLIP_H_
