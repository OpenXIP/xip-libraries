...
{
	SO_ENGINE_HEADER( SoVtkImageChangeInformation );

public:

	/// Constructor
	SoVtkImageChangeInformation();
	...
	// Inputs
	/// ExtentTranslation
	SoSFVec3f ExtentTranslation;
	/// OutputExtentStart
	SoSFVec3f OutputExtentStart;
	/// OutputOrigin
	SoSFVec3f OutputOrigin;
	/// OutputSpacing
	SoSFVec3f OutputSpacing;
	/// OriginScale
	SoSFVec3f OriginScale;
	/// InformationInput of type vtkImageData
	SoSFVtkObject InformationInput;
	/// OriginTranslation
	SoSFVec3f OriginTranslation;
	/// CenterImage
	SoSFInt32 CenterImage;
	/// SpacingScale
	SoSFVec3f SpacingScale;
	/// Input connection 
	...
	SoEngineOutput oInformationInput;
	/// SoSFVtkObject of type vtkImageData
...
private:
	...
	vtkImageChangeInformation* mObject;
