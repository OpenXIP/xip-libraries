...
# ifndef SO_VTK_IMAGERANGE3D_H_
# define SO_VTK_IMAGERANGE3D_H_
...
class SoVtkImageRange3D : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkImageRange3D );
...
private:
	...
	vtkImageRange3D* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_IMAGERANGE3D_H_
