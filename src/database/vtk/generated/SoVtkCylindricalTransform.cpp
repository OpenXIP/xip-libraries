...
# include "SoVtkCylindricalTransform.h"
# include "SoVtkUtils.h"

# include "vtkAbstractTransform.h"


SO_ENGINE_SOURCE( SoVtkCylindricalTransform )
...
void SoVtkCylindricalTransform::evaluate()
{
	try
	{
...
void SoVtkCylindricalTransform::inputChanged(SoField * f)
{
...
void SoVtkCylindricalTransform::reset()
{
	mObject->UnRegister(0);
	mObject->Delete();
	mObject = 0;
