...
SO_ENGINE_SOURCE( SoVtkStructuredGridOutlineFilter )

SoVtkStructuredGridOutlineFilter::SoVtkStructuredGridOutlineFilter()
{
	SO_ENGINE_CONSTRUCTOR(SoVtkStructuredGridOutlineFilter);

	mObject = vtkStructuredGridOutlineFilter::New();
	...
	aStructuredGridOutlineFilter->Delete();
...
void SoVtkStructuredGridOutlineFilter::initClass()
{
	SO_ENGINE_INIT_CLASS( SoVtkStructuredGridOutlineFilter, SoEngine, "Engine" );
}

void SoVtkStructuredGridOutlineFilter::evaluate()
{
	try
	{
		// Deletion of the objects if they exist
...
void SoVtkStructuredGridOutlineFilter::inputChanged(SoField * f)
{
