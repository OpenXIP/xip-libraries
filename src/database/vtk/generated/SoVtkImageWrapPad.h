...
# ifndef SO_VTK_IMAGEWRAPPAD_H_
# define SO_VTK_IMAGEWRAPPAD_H_
...
class SoVtkImageWrapPad : public SoEngine
{
	SO_ENGINE_HEADER( SoVtkImageWrapPad );
...
private:
	...
	vtkImageWrapPad* mObject;
	/// addCalled checks if the Add*() method has been called 
	bool addCalled;
};

#endif // SO_VTK_IMAGEWRAPPAD_H_
