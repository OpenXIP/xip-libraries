...
SO_ENGINE_SOURCE( SoItkGradientMagnitudeImageFilter );

SoItkGradientMagnitudeImageFilter::SoItkGradientMagnitudeImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGradientMagnitudeImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkGradientMagnitudeImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkGradientMagnitudeImageFilter::checkInput()
{
...
void
SoItkGradientMagnitudeImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
