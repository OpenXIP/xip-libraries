...
SO_ENGINE_SOURCE( SoItkBSplineUpsampleImageFilter );

SoItkBSplineUpsampleImageFilter::SoItkBSplineUpsampleImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkBSplineUpsampleImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkBSplineUpsampleImageFilter, SoItkBSplineResampleImageFilterBase, "SoItkBSplineResampleImageFilterBase" );
}

bool
SoItkBSplineUpsampleImageFilter::checkInput()
{
...
void
SoItkBSplineUpsampleImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::BSplineUpsampleImageFilter< InputImageType, OutputImageType > FilterType;
