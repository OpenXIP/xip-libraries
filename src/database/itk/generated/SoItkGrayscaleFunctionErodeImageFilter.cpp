...
SO_ENGINE_SOURCE( SoItkGrayscaleFunctionErodeImageFilter );

SoItkGrayscaleFunctionErodeImageFilter::SoItkGrayscaleFunctionErodeImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGrayscaleFunctionErodeImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkGrayscaleFunctionErodeImageFilter, SoItkMorphologyImageFilter, "SoItkMorphologyImageFilter" );
}

bool
SoItkGrayscaleFunctionErodeImageFilter::checkInput()
{
...
void
SoItkGrayscaleFunctionErodeImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::GrayscaleFunctionErodeImageFilter< InputImageType, OutputImageType, KernelType > FilterType;
