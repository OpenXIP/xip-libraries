...
SO_ENGINE_SOURCE( SoItkSmoothingRecursiveGaussianImageFilter );

SoItkSmoothingRecursiveGaussianImageFilter::SoItkSmoothingRecursiveGaussianImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkSmoothingRecursiveGaussianImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Sigma, (0) );
...
{
	SO_ENGINE_INIT_CLASS( SoItkSmoothingRecursiveGaussianImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkSmoothingRecursiveGaussianImageFilter::checkInput()
{
...
void
SoItkSmoothingRecursiveGaussianImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
