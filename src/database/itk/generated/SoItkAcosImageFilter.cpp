...
SO_ENGINE_SOURCE( SoItkAcosImageFilter );

SoItkAcosImageFilter::SoItkAcosImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkAcosImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkAcosImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkAcosImageFilter::checkInput()
{
