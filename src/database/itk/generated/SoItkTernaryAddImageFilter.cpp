...
SO_ENGINE_SOURCE( SoItkTernaryAddImageFilter );

SoItkTernaryAddImageFilter::SoItkTernaryAddImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkTernaryAddImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkTernaryAddImageFilter, SoItkTernaryFunctorImageFilter, "SoItkTernaryFunctorImageFilter" );
}

bool
SoItkTernaryAddImageFilter::checkInput()
{
...
void
SoItkTernaryAddImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case 2:
			{
				switch( Input2.getValue()->getType() )
				{
					case SoItkDataImage::FLOAT:
					{
						...
						typedef itk::TernaryAddImageFilter< InputImageType, InputImageType, InputImageType, OutputImageType > FilterType;
