...
SO_ENGINE_SOURCE( SoItkDoubleThresholdImageFilter );

SoItkDoubleThresholdImageFilter::SoItkDoubleThresholdImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkDoubleThresholdImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Threshold1, (0) );
	SO_ENGINE_ADD_INPUT( Threshold3, (65535) );
	SO_ENGINE_ADD_INPUT( InsideValue, (65535) );
	SO_ENGINE_ADD_INPUT( Threshold2, (0) );
	SO_ENGINE_ADD_INPUT( OutsideValue, (0) );
	SO_ENGINE_ADD_INPUT( FullyConnected, (false) );
	SO_ENGINE_ADD_INPUT( Threshold4, (65535) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkDoubleThresholdImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkDoubleThresholdImageFilter::checkInput()
{
...
void
SoItkDoubleThresholdImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						SO_ITK_SET_FIELD_VALUE( filter, Threshold1 );
						SO_ITK_SET_FIELD_VALUE( filter, Threshold3 );
						SO_ITK_SET_FIELD_VALUE( filter, InsideValue );
						SO_ITK_SET_FIELD_VALUE( filter, Threshold2 );
						SO_ITK_SET_FIELD_VALUE( filter, OutsideValue );
						SO_ITK_SET_FIELD_VALUE( filter, FullyConnected );
						SO_ITK_SET_FIELD_VALUE( filter, Threshold4 );
