...
SO_ENGINE_SOURCE( SoItkHMaximaImageFilter );

SoItkHMaximaImageFilter::SoItkHMaximaImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkHMaximaImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkHMaximaImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkHMaximaImageFilter::checkInput()
{
...
void
SoItkHMaximaImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
