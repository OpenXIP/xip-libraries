...
SO_ENGINE_SOURCE( SoItkHardConnectedComponentImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkHardConnectedComponentImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkHardConnectedComponentImageFilter::checkInput()
{
...
void
SoItkHardConnectedComponentImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
