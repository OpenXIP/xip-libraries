...
SO_ENGINE_SOURCE( SoItkGrayscaleFillholeImageFilter );

SoItkGrayscaleFillholeImageFilter::SoItkGrayscaleFillholeImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGrayscaleFillholeImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkGrayscaleFillholeImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkGrayscaleFillholeImageFilter::checkInput()
{
...
void
SoItkGrayscaleFillholeImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
