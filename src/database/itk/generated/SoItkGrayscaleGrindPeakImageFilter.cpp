...
SO_ENGINE_SOURCE( SoItkGrayscaleGrindPeakImageFilter );

SoItkGrayscaleGrindPeakImageFilter::SoItkGrayscaleGrindPeakImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGrayscaleGrindPeakImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkGrayscaleGrindPeakImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkGrayscaleGrindPeakImageFilter::checkInput()
{
...
void
SoItkGrayscaleGrindPeakImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
