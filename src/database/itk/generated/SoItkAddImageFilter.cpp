...
SO_ENGINE_SOURCE( SoItkAddImageFilter );

SoItkAddImageFilter::SoItkAddImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkAddImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkAddImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkAddImageFilter::checkInput()
{
