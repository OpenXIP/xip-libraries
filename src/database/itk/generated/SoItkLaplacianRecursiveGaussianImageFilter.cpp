...
SO_ENGINE_SOURCE( SoItkLaplacianRecursiveGaussianImageFilter );

SoItkLaplacianRecursiveGaussianImageFilter::SoItkLaplacianRecursiveGaussianImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkLaplacianRecursiveGaussianImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkLaplacianRecursiveGaussianImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkLaplacianRecursiveGaussianImageFilter::checkInput()
{
...
void
SoItkLaplacianRecursiveGaussianImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
