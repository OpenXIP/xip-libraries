...
SO_ENGINE_SOURCE( SoItkVotingBinaryImageFilter );

SoItkVotingBinaryImageFilter::SoItkVotingBinaryImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkVotingBinaryImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkVotingBinaryImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkVotingBinaryImageFilter::checkInput()
{
...
void
SoItkVotingBinaryImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
