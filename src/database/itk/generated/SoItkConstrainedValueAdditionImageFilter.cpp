...
SO_ENGINE_SOURCE( SoItkConstrainedValueAdditionImageFilter );

SoItkConstrainedValueAdditionImageFilter::SoItkConstrainedValueAdditionImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkConstrainedValueAdditionImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkConstrainedValueAdditionImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkConstrainedValueAdditionImageFilter::checkInput()
{
...
void
SoItkConstrainedValueAdditionImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case 2:
			{
				switch( Input1.getValue()->getType() )
				{
					case SoItkDataImage::FLOAT:
					{
						...
						typedef itk::ConstrainedValueAdditionImageFilter< InputImageType, InputImageType, OutputImageType > FilterType;
