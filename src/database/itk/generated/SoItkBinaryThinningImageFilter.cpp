...
SO_ENGINE_SOURCE( SoItkBinaryThinningImageFilter );

SoItkBinaryThinningImageFilter::SoItkBinaryThinningImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkBinaryThinningImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkBinaryThinningImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkBinaryThinningImageFilter::checkInput()
{
...
void
SoItkBinaryThinningImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
