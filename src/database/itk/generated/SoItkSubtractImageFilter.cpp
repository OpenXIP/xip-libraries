...
SO_ENGINE_SOURCE( SoItkSubtractImageFilter );

SoItkSubtractImageFilter::SoItkSubtractImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkSubtractImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkSubtractImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkSubtractImageFilter::checkInput()
{
...
void
SoItkSubtractImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case 2:
			{
				switch( Input1.getValue()->getType() )
				{
					case SoItkDataImage::FLOAT:
					{
						...
						typedef itk::SubtractImageFilter< InputImageType, InputImageType, OutputImageType > FilterType;
