...
SO_ENGINE_SOURCE( SoItkCannySegmentationLevelSetImageFilter );

SoItkCannySegmentationLevelSetImageFilter::SoItkCannySegmentationLevelSetImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkCannySegmentationLevelSetImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Threshold, (0) );
	SO_ENGINE_ADD_INPUT( Variance, (0) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkCannySegmentationLevelSetImageFilter, SoItkSegmentationLevelSetImageFilter, "SoItkSegmentationLevelSetImageFilter" );
}

bool
SoItkCannySegmentationLevelSetImageFilter::checkInput()
{
...
void
SoItkCannySegmentationLevelSetImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case 2:
			{
				switch( FeatureImage.getValue()->getType() )
				{
					case SoItkDataImage::FLOAT:
					{
						...
						typedef itk::CannySegmentationLevelSetImageFilter< InputImageType, OutputImageType > FilterType;
