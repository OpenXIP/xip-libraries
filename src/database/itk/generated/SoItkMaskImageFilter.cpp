...
SO_ENGINE_SOURCE( SoItkMaskImageFilter );

SoItkMaskImageFilter::SoItkMaskImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkMaskImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkMaskImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkMaskImageFilter::checkInput()
{
