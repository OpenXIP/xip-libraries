...
SO_ENGINE_SOURCE( SoItkGrayscaleMorphologicalClosingImageFilter );

SoItkGrayscaleMorphologicalClosingImageFilter::SoItkGrayscaleMorphologicalClosingImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGrayscaleMorphologicalClosingImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkGrayscaleMorphologicalClosingImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkGrayscaleMorphologicalClosingImageFilter::checkInput()
{
...
void
SoItkGrayscaleMorphologicalClosingImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::GrayscaleMorphologicalClosingImageFilter< InputImageType, OutputImageType, KernelType > FilterType;
