...
SO_ENGINE_SOURCE( SoItkWrapPadImageFilter );

SoItkWrapPadImageFilter::SoItkWrapPadImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkWrapPadImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkWrapPadImageFilter, SoItkPadImageFilter, "SoItkPadImageFilter" );
}

bool
SoItkWrapPadImageFilter::checkInput()
{
...
void
SoItkWrapPadImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::WrapPadImageFilter< InputImageType, OutputImageType > FilterType;
