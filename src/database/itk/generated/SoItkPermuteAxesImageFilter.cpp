...
SO_ENGINE_SOURCE( SoItkPermuteAxesImageFilter );

SoItkPermuteAxesImageFilter::SoItkPermuteAxesImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkPermuteAxesImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkPermuteAxesImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkPermuteAxesImageFilter::checkInput()
{
...
void
SoItkPermuteAxesImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::PermuteAxesImageFilter< OutputImageType > FilterType;
						
						FilterType::Pointer filter = FilterType::New();
						
						// Set the filter's inputs
						SO_ITK_SET_FIELD_FIXEDARRAY( filter, Order, unsigned int, 2 );
					...
					case 3:
					{
						...
						// Set the filter's inputs
						SO_ITK_SET_FIELD_FIXEDARRAY( filter, Order, unsigned int, 3 );
