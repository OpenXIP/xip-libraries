...
SO_ENGINE_SOURCE( SoItkVotingBinaryIterativeHoleFillingImageFilter );

SoItkVotingBinaryIterativeHoleFillingImageFilter::SoItkVotingBinaryIterativeHoleFillingImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkVotingBinaryIterativeHoleFillingImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Radius, (0) );
	Radius.setNum(0);
	SO_ENGINE_ADD_INPUT( MaximumNumberOfIterations, (10) );
	SO_ENGINE_ADD_INPUT( CurrentNumberOfIterations, (0) );
	SO_ENGINE_ADD_INPUT( BackgroundValue, (0) );
	SO_ENGINE_ADD_INPUT( MajorityThreshold, (1) );
	SO_ENGINE_ADD_INPUT( ForegroundValue, (65535) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkVotingBinaryIterativeHoleFillingImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkVotingBinaryIterativeHoleFillingImageFilter::checkInput()
{
...
void
SoItkVotingBinaryIterativeHoleFillingImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						SO_ITK_SET_FIELD_VALUE( filter, MaximumNumberOfIterations );
						SO_ITK_SET_FIELD_VALUE( filter, CurrentNumberOfIterations );
						SO_ITK_SET_FIELD_VALUE( filter, BackgroundValue );
						SO_ITK_SET_FIELD_VALUE( filter, MajorityThreshold );
						SO_ITK_SET_FIELD_VALUE( filter, ForegroundValue );
