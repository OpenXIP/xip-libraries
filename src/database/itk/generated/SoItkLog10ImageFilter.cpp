...
SO_ENGINE_SOURCE( SoItkLog10ImageFilter );

SoItkLog10ImageFilter::SoItkLog10ImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkLog10ImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkLog10ImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkLog10ImageFilter::checkInput()
{
...
void
SoItkLog10ImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
