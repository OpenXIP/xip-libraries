...
SO_ENGINE_SOURCE( SoItkTanImageFilter );

SoItkTanImageFilter::SoItkTanImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkTanImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkTanImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkTanImageFilter::checkInput()
{
