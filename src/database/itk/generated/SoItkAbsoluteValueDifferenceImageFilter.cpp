...
SO_ENGINE_SOURCE( SoItkAbsoluteValueDifferenceImageFilter );

SoItkAbsoluteValueDifferenceImageFilter::SoItkAbsoluteValueDifferenceImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkAbsoluteValueDifferenceImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkAbsoluteValueDifferenceImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkAbsoluteValueDifferenceImageFilter::checkInput()
{
...
void
SoItkAbsoluteValueDifferenceImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
