...
SO_ENGINE_SOURCE( SoItkBinaryDilateImageFilter );

SoItkBinaryDilateImageFilter::SoItkBinaryDilateImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkBinaryDilateImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkBinaryDilateImageFilter, SoItkMorphologyImageFilter, "SoItkMorphologyImageFilter" );
}

bool
SoItkBinaryDilateImageFilter::checkInput()
{
...
void
SoItkBinaryDilateImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
