...
SO_ENGINE_SOURCE( SoItkGrayscaleConnectedClosingImageFilter );

SoItkGrayscaleConnectedClosingImageFilter::SoItkGrayscaleConnectedClosingImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGrayscaleConnectedClosingImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkGrayscaleConnectedClosingImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkGrayscaleConnectedClosingImageFilter::checkInput()
{
...
void
SoItkGrayscaleConnectedClosingImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::GrayscaleConnectedClosingImageFilter< InputImageType, OutputImageType > FilterType;
