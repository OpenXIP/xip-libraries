...
SO_ENGINE_SOURCE( SoItkApproximateSignedDistanceMapImageFilter );

SoItkApproximateSignedDistanceMapImageFilter::SoItkApproximateSignedDistanceMapImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkApproximateSignedDistanceMapImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkApproximateSignedDistanceMapImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkApproximateSignedDistanceMapImageFilter::checkInput()
{
...
void
SoItkApproximateSignedDistanceMapImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
