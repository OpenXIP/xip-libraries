...
class XIPIVITK_API SoItkGrayscaleGeodesicErodeImageFilter : public SoItkImageToImageFilter
{
	SO_ENGINE_HEADER( GrayscaleGeodesicErodeImageFilter );

public:
	SoItkGrayscaleGeodesicErodeImageFilter();
...
#endif // SO_ITK_GRAYSCALEGEODESICERODEIMAGEFILTER_H_
