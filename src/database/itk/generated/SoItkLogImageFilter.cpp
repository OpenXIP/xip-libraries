...
SO_ENGINE_SOURCE( SoItkLogImageFilter );

SoItkLogImageFilter::SoItkLogImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkLogImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkLogImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkLogImageFilter::checkInput()
{
