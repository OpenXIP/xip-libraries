...
SO_ENGINE_SOURCE( SoItkFastIncrementalBinaryDilateImageFilter );

SoItkFastIncrementalBinaryDilateImageFilter::SoItkFastIncrementalBinaryDilateImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkFastIncrementalBinaryDilateImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Kernel, (0) );
	SO_ENGINE_ADD_INPUT( BackgroundValue, (0) );
	SO_ENGINE_ADD_INPUT( DilateValue, (65535) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkFastIncrementalBinaryDilateImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkFastIncrementalBinaryDilateImageFilter::checkInput()
{
...
void
SoItkFastIncrementalBinaryDilateImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::FastIncrementalBinaryDilateImageFilter< InputImageType, OutputImageType, KernelType > FilterType;
						...
						SO_ITK_SET_FIELD_VALUE( filter, DilateValue );
