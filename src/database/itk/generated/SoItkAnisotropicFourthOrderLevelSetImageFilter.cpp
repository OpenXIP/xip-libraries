...
SO_ENGINE_SOURCE( SoItkAnisotropicFourthOrderLevelSetImageFilter );

SoItkAnisotropicFourthOrderLevelSetImageFilter::SoItkAnisotropicFourthOrderLevelSetImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkAnisotropicFourthOrderLevelSetImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkAnisotropicFourthOrderLevelSetImageFilter, SoItkSparseFieldFourthOrderLevelSetImageFilter, "SoItkSparseFieldFourthOrderLevelSetImageFilter" );
}

bool
SoItkAnisotropicFourthOrderLevelSetImageFilter::checkInput()
{
...
void
SoItkAnisotropicFourthOrderLevelSetImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::AnisotropicFourthOrderLevelSetImageFilter< InputImageType, OutputImageType > FilterType;
