...
SO_ENGINE_SOURCE( SoItkDivideImageFilter );

SoItkDivideImageFilter::SoItkDivideImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkDivideImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkDivideImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkDivideImageFilter::checkInput()
{
...
void
SoItkDivideImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
