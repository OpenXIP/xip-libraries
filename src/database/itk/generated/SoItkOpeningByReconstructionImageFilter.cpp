...
SO_ENGINE_SOURCE( SoItkOpeningByReconstructionImageFilter );

SoItkOpeningByReconstructionImageFilter::SoItkOpeningByReconstructionImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkOpeningByReconstructionImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkOpeningByReconstructionImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkOpeningByReconstructionImageFilter::checkInput()
{
...
void
SoItkOpeningByReconstructionImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
