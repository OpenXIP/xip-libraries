...
SO_ENGINE_SOURCE( SoItkSquareImageFilter );

SoItkSquareImageFilter::SoItkSquareImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkSquareImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkSquareImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkSquareImageFilter::checkInput()
{
...
void
SoItkSquareImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
