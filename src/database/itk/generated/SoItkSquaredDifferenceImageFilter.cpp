...
SO_ENGINE_SOURCE( SoItkSquaredDifferenceImageFilter );

SoItkSquaredDifferenceImageFilter::SoItkSquaredDifferenceImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkSquaredDifferenceImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkSquaredDifferenceImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkSquaredDifferenceImageFilter::checkInput()
{
...
void
SoItkSquaredDifferenceImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
