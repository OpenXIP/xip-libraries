...
SO_ENGINE_SOURCE( SoItkNormalizedCorrelationImageFilter );

SoItkNormalizedCorrelationImageFilter::SoItkNormalizedCorrelationImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkNormalizedCorrelationImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Input1, (0) );
	SO_ENGINE_ADD_INPUT( Template, (0) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkNormalizedCorrelationImageFilter, SoItkNeighborhoodOperatorImageFilter, "SoItkNeighborhoodOperatorImageFilter" );
}

bool
SoItkNormalizedCorrelationImageFilter::checkInput()
{
...
void
SoItkNormalizedCorrelationImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::NormalizedCorrelationImageFilter< InputImageType, InputImageType, OutputImageType > FilterType;
						...
						SO_ITK_SET_FIELD_DATA_VALUE( filter, Template, KernelType );
