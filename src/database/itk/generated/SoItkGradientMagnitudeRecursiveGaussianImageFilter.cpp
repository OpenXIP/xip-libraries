...
SO_ENGINE_SOURCE( SoItkGradientMagnitudeRecursiveGaussianImageFilter );

SoItkGradientMagnitudeRecursiveGaussianImageFilter::SoItkGradientMagnitudeRecursiveGaussianImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGradientMagnitudeRecursiveGaussianImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( Sigma, (1) );
...
{
	SO_ENGINE_INIT_CLASS( SoItkGradientMagnitudeRecursiveGaussianImageFilter, SoItkInPlaceImageFilter, "SoItkInPlaceImageFilter" );
}

bool
SoItkGradientMagnitudeRecursiveGaussianImageFilter::checkInput()
{
...
void
SoItkGradientMagnitudeRecursiveGaussianImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
