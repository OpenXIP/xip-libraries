...
SO_ENGINE_SOURCE( SoItkNotImageFilter );

SoItkNotImageFilter::SoItkNotImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkNotImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkNotImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkNotImageFilter::checkInput()
{
