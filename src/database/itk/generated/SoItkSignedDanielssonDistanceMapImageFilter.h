...
{
	SO_ENGINE_HEADER( SignedDanielssonDistanceMapImageFilter );

public:
	SoItkSignedDanielssonDistanceMapImageFilter();

	SoSFBool UseImageSpacing;
	SoSFBool InsideIsPositive;
...
#endif // SO_ITK_SIGNEDDANIELSSONDISTANCEMAPIMAGEFILTER_H_
