...
SO_ENGINE_SOURCE( SoItkGeodesicActiveContourShapePriorLevelSetImageFilter );

SoItkGeodesicActiveContourShapePriorLevelSetImageFilter::SoItkGeodesicActiveContourShapePriorLevelSetImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGeodesicActiveContourShapePriorLevelSetImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( DerivativeSigma, (0) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkGeodesicActiveContourShapePriorLevelSetImageFilter, SoItkShapePriorSegmentationLevelSetImageFilter, "SoItkShapePriorSegmentationLevelSetImageFilter" );
}

bool
SoItkGeodesicActiveContourShapePriorLevelSetImageFilter::checkInput()
{
...
void
SoItkGeodesicActiveContourShapePriorLevelSetImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case 2:
			{
				switch( FeatureImage.getValue()->getType() )
				{
					case SoItkDataImage::FLOAT:
					{
						...
						typedef itk::GeodesicActiveContourShapePriorLevelSetImageFilter< InputImageType, OutputImageType > FilterType;
						
						FilterType::Pointer filter = FilterType::New();
						
						// Set the filter's inputs
						SO_ITK_SET_FIELD_VALUE( filter, DerivativeSigma );
						
						// Inherited from SoItkShapePriorSegmentationLevelSetImageFilter
						SO_ITK_SET_FIELD_VALUE( filter, InitialParameters );
						SO_ITK_SET_FIELD_VALUE( filter, ShapePriorScaling );
