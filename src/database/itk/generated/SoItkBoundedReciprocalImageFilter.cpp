...
SO_ENGINE_SOURCE( SoItkBoundedReciprocalImageFilter );

SoItkBoundedReciprocalImageFilter::SoItkBoundedReciprocalImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkBoundedReciprocalImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkBoundedReciprocalImageFilter, SoItkUnaryFunctorImageFilter, "SoItkUnaryFunctorImageFilter" );
}

bool
SoItkBoundedReciprocalImageFilter::checkInput()
{
...
void
SoItkBoundedReciprocalImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
