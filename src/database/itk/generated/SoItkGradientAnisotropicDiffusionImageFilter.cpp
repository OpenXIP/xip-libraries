...
SO_ENGINE_SOURCE( SoItkGradientAnisotropicDiffusionImageFilter );

SoItkGradientAnisotropicDiffusionImageFilter::SoItkGradientAnisotropicDiffusionImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkGradientAnisotropicDiffusionImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkGradientAnisotropicDiffusionImageFilter, SoItkAnisotropicDiffusionImageFilter, "SoItkAnisotropicDiffusionImageFilter" );
}

bool
SoItkGradientAnisotropicDiffusionImageFilter::checkInput()
{
...
void
SoItkGradientAnisotropicDiffusionImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
