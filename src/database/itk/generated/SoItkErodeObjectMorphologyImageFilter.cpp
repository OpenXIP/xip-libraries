...
SO_ENGINE_SOURCE( SoItkErodeObjectMorphologyImageFilter );

SoItkErodeObjectMorphologyImageFilter::SoItkErodeObjectMorphologyImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkErodeObjectMorphologyImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkErodeObjectMorphologyImageFilter, SoItkObjectMorphologyImageFilter, "SoItkObjectMorphologyImageFilter" );
}

bool
SoItkErodeObjectMorphologyImageFilter::checkInput()
{
...
void
SoItkErodeObjectMorphologyImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::ErodeObjectMorphologyImageFilter< InputImageType, OutputImageType, KernelType > FilterType;
						...
						// Inherited from SoItkObjectMorphologyImageFilter
						SO_ITK_SET_FIELD_VALUE( filter, UseBoundaryCondition );
						SO_ITK_SET_FIELD_VALUE( filter, ObjectValue );
						typedef itk::Neighborhood< float, 2 > KernelType;
