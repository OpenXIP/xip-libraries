...
SO_ENGINE_SOURCE( SoItkAtan2ImageFilter );

SoItkAtan2ImageFilter::SoItkAtan2ImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkAtan2ImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkAtan2ImageFilter, SoItkBinaryFunctorImageFilter, "SoItkBinaryFunctorImageFilter" );
}

bool
SoItkAtan2ImageFilter::checkInput()
{
...
void
SoItkAtan2ImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case 2:
			{
				switch( Input1.getValue()->getType() )
				{
					case SoItkDataImage::FLOAT:
					{
						...
						typedef itk::Atan2ImageFilter< InputImageType, InputImageType, OutputImageType > FilterType;
