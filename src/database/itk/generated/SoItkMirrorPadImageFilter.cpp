...
SO_ENGINE_SOURCE( SoItkMirrorPadImageFilter );

SoItkMirrorPadImageFilter::SoItkMirrorPadImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkMirrorPadImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkMirrorPadImageFilter, SoItkPadImageFilter, "SoItkPadImageFilter" );
}

bool
SoItkMirrorPadImageFilter::checkInput()
{
...
void
SoItkMirrorPadImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::MirrorPadImageFilter< InputImageType, OutputImageType > FilterType;
						
						FilterType::Pointer filter = FilterType::New();
						
						// Set the filter's inputs
						
						// Inherited from SoItkPadImageFilter
