...
SO_ENGINE_SOURCE( SoItkOtsuMultipleThresholdsImageFilter );

SoItkOtsuMultipleThresholdsImageFilter::SoItkOtsuMultipleThresholdsImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkOtsuMultipleThresholdsImageFilter );
	
	// Inputs
	SO_ENGINE_ADD_INPUT( NumberOfThresholds, (1) );
	SO_ENGINE_ADD_INPUT( NumberOfHistogramBins, (1) );
	SO_ENGINE_ADD_INPUT( LabelOffset, (0) );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkOtsuMultipleThresholdsImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkOtsuMultipleThresholdsImageFilter::checkInput()
{
...
void
SoItkOtsuMultipleThresholdsImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						SO_ITK_SET_FIELD_VALUE( filter, NumberOfThresholds );
						SO_ITK_SET_FIELD_VALUE( filter, NumberOfHistogramBins );
						SO_ITK_SET_FIELD_VALUE( filter, LabelOffset );
