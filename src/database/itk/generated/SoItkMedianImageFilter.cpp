...
SO_ENGINE_SOURCE( SoItkMedianImageFilter );

SoItkMedianImageFilter::SoItkMedianImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkMedianImageFilter );
...
{
	SO_ENGINE_INIT_CLASS( SoItkMedianImageFilter, SoItkImageToImageFilter, "SoItkImageToImageFilter" );
}

bool
SoItkMedianImageFilter::checkInput()
{
...
void
SoItkMedianImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
