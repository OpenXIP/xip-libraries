...
SO_ENGINE_SOURCE( SoItkDilateObjectMorphologyImageFilter );

SoItkDilateObjectMorphologyImageFilter::SoItkDilateObjectMorphologyImageFilter()
{
	SO_ENGINE_CONSTRUCTOR( SoItkDilateObjectMorphologyImageFilter );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkDilateObjectMorphologyImageFilter, SoItkObjectMorphologyImageFilter, "SoItkObjectMorphologyImageFilter" );
}

bool
SoItkDilateObjectMorphologyImageFilter::checkInput()
{
...
void
SoItkDilateObjectMorphologyImageFilter::evaluate()
{
	if( mOutput )
	{
		mOutput->unref();
			...
			case SoItkDataImage::FLOAT:
			{
				switch( Input0.getValue()->getNumDimension() )
				{
					case 2:
					{
						...
						typedef itk::DilateObjectMorphologyImageFilter< InputImageType, OutputImageType, KernelType > FilterType;
