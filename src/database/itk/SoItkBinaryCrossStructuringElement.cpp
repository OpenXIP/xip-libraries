...
SO_ENGINE_SOURCE( SoItkBinaryCrossStructuringElement )

SoItkBinaryCrossStructuringElement::SoItkBinaryCrossStructuringElement()
{
	SO_ENGINE_CONSTRUCTOR( SoItkBinaryCrossStructuringElement );
}
...
{
	SO_ENGINE_INIT_CLASS( SoItkBinaryCrossStructuringElement, SoItkNeighborhood, "SoItkNeighborhood" );	
}

void
SoItkBinaryCrossStructuringElement::evaluate()
{
    if( mOutput )
    {
        mOutput->unref();
        ...
        switch( PixelType.getValue() )
		{
			case FLOAT:
			{
				switch( Dimension.getValue() )
				{
					case 2:
					{
                        typedef itk::BinaryCrossStructuringElement< float, 2 > NeighborhoodType;
					...
					case 3:
					{
                        typedef itk::BinaryCrossStructuringElement< float, 3 > NeighborhoodType;
                        NeighborhoodType* neighborhood = new NeighborhoodType;
			...
			case UNSIGNED_SHORT:
			{
				switch( Dimension.getValue() )
				{
					case 2:
					{
                        typedef itk::BinaryCrossStructuringElement< unsigned short, 2 > NeighborhoodType;
                        NeighborhoodType* neighborhood = new NeighborhoodType;
					...
					case 3:
					{
                        typedef itk::BinaryCrossStructuringElement< unsigned short, 3 > NeighborhoodType;
                        NeighborhoodType* neighborhood = new NeighborhoodType;
