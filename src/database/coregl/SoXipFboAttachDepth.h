...
#ifndef SO_XIP_FBO_ATTACH_DEPTH_H
#define SO_XIP_FBO_ATTACH_DEPTH_H


/**
 *  Component       : XIP
 *  Name            : SoXipFboAttachDepth
...
class SoXipFboAttachDepth : public SoNode
{
	SO_NODE_HEADER(SoXipFboAttachDepth);
