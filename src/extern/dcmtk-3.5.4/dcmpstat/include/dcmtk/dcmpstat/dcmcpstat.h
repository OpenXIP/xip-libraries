...
#ifndef DCMCPSTAT_H__
#define DCMCPSTAT_H__
...
public:
  /** default constructor
   */
  DcmColorPresentationState();

  /// destructor
  virtual ~DcmColorPresentationState();
   ...
   *  A number of flags specify how curves, overlays and a display shutter
  ...
  /** sets the ICC Profile for this presentation state.
...
private:
   ...
   */
  DcmColorPresentationState(const DcmColorPresentationState& copy);

  /** private undefined assignment operator
   */
  DcmColorPresentationState& operator=(const DcmColorPresentationState& obj);
...
protected:
  ...
  /* Module: ICC Profile (C)
   * "contains Attributes that identify and describe an ICC Profile"
   */
  /// Module=ICC Profile, VR=OB, VM=1, Type 1
