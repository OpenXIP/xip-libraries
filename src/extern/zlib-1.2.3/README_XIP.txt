This directory contains a subset of the zlib library (1.2.3), modified
by Kitware Inc. for VTK. Some custom changes have been applied.
...
vs the original zlib code made by Kitware Inc. for VTK.
