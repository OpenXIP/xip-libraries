...
#line 119 "SoCalcParse.y"
{
    Expr	*expr;
    ExprList	*list;
}
/* Line 193 of yacc.c.  */
#line 225 "SoCalcParse.tab.c"
	YYSTYPE;
...
{
       0,     0,     3,     5,     9,    12,    16,    23,    27,    34,
      36,    38,    40,    42,    46,    48,    53,    58,    60,    64,
      66,    69,    72,    74,    78,    82,    86,    88,    92,    96,
      98,   102,   106,   110,   114,   116,   120,   124,   126,   130,
     132,   136,   138
};
...
{
      33,     0,    -1,    34,    -1,    33,    15,    34,    -1,    33,
      15,    -1,     7,    16,    45,    -1,     7,    17,    45,    18,
      16,    45,    -1,     8,    16,    45,    -1,     8,    17,    45,
      18,    16,    45,    -1,     4,    -1,     6,    -1,     7,    -1,
       8,    -1,    19,    45,    20,    -1,    35,    -1,    36,    17,
      45,    18,    -1,     5,    19,    37,    20,    -1,    45,    -1,
      37,    21,    45,    -1,    36,    -1,    22,    38,    -1,    23,
      38,    -1,    38,    -1,    39,    24,    38,    -1,    39,    25,
      38,    -1,    39,    26,    38,    -1,    39,    -1,    40,    27,
      39,    -1,    40,    22,    39,    -1,    40,    -1,    41,    28,
      40,    -1,    41,    29,    40,    -1,    41,    12,    40,    -1,
      41,    11,    40,    -1,    41,    -1,    42,    13,    41,    -1,
      42,    14,    41,    -1,    42,    -1,    43,    10,    42,    -1,
      43,    -1,    44,     9,    43,    -1,    44,    -1,    44,    30,
      45,    31,    45,    -1
};
...
{
       0,   135,   135,   136,   137,   141,   143,   145,   147,   152,
     153,   154,   155,   156,   160,   161,   163,   167,   168,   172,
     173,   174,   178,   179,   181,   183,   188,   189,   191,   196,
     197,   199,   201,   203,   208,   209,   211,   216,   217,   222,
     223,   228,   229
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 135 "SoCalcParse.y"
    { EList->append((yyvsp[(1) - (1)].expr)); ;}
    break;

  case 3:
#line 136 "SoCalcParse.y"
    { EList->append((yyvsp[(3) - (3)].expr)); ;}
    break;

  case 5:
#line 142 "SoCalcParse.y"
    { (yyval.expr) = new Assign((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 6:
#line 144 "SoCalcParse.y"
    { (yyval.expr) = new AssignIndex((yyvsp[(1) - (6)].expr), (yyvsp[(3) - (6)].expr), (yyvsp[(6) - (6)].expr)); ;}
    break;
...
#line 162 "SoCalcParse.y"
    { (yyval.expr) = new Index((yyvsp[(1) - (4)].expr), (yyvsp[(3) - (4)].expr)); ;}
    break;

  case 16:
#line 163 "SoCalcParse.y"
    { ((Func *)(yyvsp[(1) - (4)].expr))->setArgs((yyvsp[(3) - (4)].list)); (yyval.expr) = (yyvsp[(1) - (4)].expr); ;}
    break;

  case 17:
#line 167 "SoCalcParse.y"
    { ((yyval.list) = new ExprList)->append((yyvsp[(1) - (1)].expr)); ;}
    break;

  case 18:
#line 168 "SoCalcParse.y"
    { (yyvsp[(1) - (3)].list)->append((yyvsp[(3) - (3)].expr)); (yyval.list) = (yyvsp[(1) - (3)].list); ;}
    break;

  case 20:
#line 173 "SoCalcParse.y"
    { (yyval.expr) = new Negate((yyvsp[(2) - (2)].expr)); ;}
    break;

  case 21:
#line 174 "SoCalcParse.y"
    { (yyval.expr) = new Not((yyvsp[(2) - (2)].expr)); ;}
    break;

  case 23:
#line 180 "SoCalcParse.y"
    { (yyval.expr) = new Mult((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 24:
#line 182 "SoCalcParse.y"
    { (yyval.expr) = new Divide((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 25:
#line 184 "SoCalcParse.y"
    { (yyval.expr) = new Mod((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 27:
#line 190 "SoCalcParse.y"
    { (yyval.expr) = new Plus((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 28:
#line 192 "SoCalcParse.y"
    { (yyval.expr) = new Minus((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 30:
#line 198 "SoCalcParse.y"
    { (yyval.expr) = new LessThan((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 31:
#line 200 "SoCalcParse.y"
    { (yyval.expr) = new GreaterThan((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 32:
#line 202 "SoCalcParse.y"
    { (yyval.expr) = new LessEQ((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 33:
#line 204 "SoCalcParse.y"
    { (yyval.expr) = new GreaterEQ((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 35:
#line 210 "SoCalcParse.y"
    { (yyval.expr) = new Equals((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 36:
#line 212 "SoCalcParse.y"
    { (yyval.expr) = new NotEquals((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 38:
#line 218 "SoCalcParse.y"
    { (yyval.expr) = new And((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 40:
#line 224 "SoCalcParse.y"
    { (yyval.expr) = new Or((yyvsp[(1) - (3)].expr), (yyvsp[(3) - (3)].expr)); ;}
    break;

  case 42:
#line 231 "SoCalcParse.y"
    { (yyval.expr) = new Ternary((yyvsp[(1) - (5)].expr), (yyvsp[(3) - (5)].expr), (yyvsp[(5) - (5)].expr)); ;}
    break;


/* Line 1267 of yacc.c.  */
#line 1657 "SoCalcParse.tab.c"
      default: break;
    }
